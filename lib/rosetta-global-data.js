...
var primaryBlacklist = [
 ...
 "eq", "is", "has", "not", "val",
 // ...It is in fact possible for 'wm' to be a valid key (it's model.substate or along those lines right now), for some reason.
 // It's been removed from the listing for now,
 //  but if this causes issues with the Rosetta system...
 "_wm", "x", "y", "z",
